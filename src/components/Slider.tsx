...
export default class Slider extends PureComponent<any, any> {

  private _panResponder: any

  private _previousLeft: any

  private _containerSize: any
  private _trackSize: any
